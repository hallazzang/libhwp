/* document.c generated by valac 0.18.1, the Vala compiler
...
GHWPDocument* ghwp_document_construct_from_uri (GType object_type, const gchar* uri, GError** error) {
	...
	_tmp0_ = uri;
	_tmp1_ = ghwp_ghwp_file_new_from_uri (_tmp0_, &_inner_error_);
	_tmp2_ = _tmp1_;
...
GHWPDocument* ghwp_document_construct_from_filename (GType object_type, const gchar* filename, GError** error) {
	...
	self = (GHWPDocument*) g_object_new (object_type, NULL);
	_tmp0_ = filename;
	_tmp1_ = ghwp_ghwp_file_new_from_filename (_tmp0_, &_inner_error_);
	_tmp2_ = _tmp1_;
	if (_inner_error_ != NULL) {
		g_propagate_error (error, _inner_error_);
		_g_object_unref0 (self);
	...
	text = _tmp0_;
	{
		...
		i = 0;
		{
			...
			while (TRUE) {
				...
				_tmp6_ = raw;
				_tmp6__length1 = raw_length1;
				_tmp7_ = i;
				_tmp8_ = _tmp6_[_tmp7_ + 1];
				_tmp9_ = raw;
				_tmp9__length1 = raw_length1;
				_tmp10_ = i;
...
static void ghwp_document_parse_summary_info (GHWPDocument* self) {
	...
	_component_guid_size_ = component_guid_length1;
